...
import {
  ChartOppurtunityComponent
} from "@app/_metronic/partials/content/widgets/_new/cards/chart-oppurtunity/chart-oppurtunity.component";
import {
  ChartAppSubmittedComponent
} from "@app/_metronic/partials/content/widgets/_new/cards/chart-app-submitted/chart-app-submitted.component";

// new
import { SimpleCardComponent } from './_new/cards/simple-card/simple-card.component';
import { InterestTableComponent } from './_new/tables/interest-table/interest-table.component';
import { CustomTableComponent } from './_new/tables/custom-table/custom-table.component';
import { ChartCardComponent } from './_new/cards/chart-cards/chart-cards.component';
@NgModule({
  declarations: [
    // Advanced Tables
